...
let modulePaths = {
 ...
 "packages/flutter_ui_bundle/background": "packages/flutter_ui_bundle/background.ddc",
 "packages/flutter_ui_bundle/inputWidget": "packages/flutter_ui_bundle/inputWidget.ddc",
 "packages/flutter_ui_bundle/loginUi": "packages/flutter_ui_bundle/loginUi.ddc",
 "packages/flutter_ui_bundle/main": "packages/flutter_ui_bundle/main.ddc",
 "packages/flutter_ui_bundle/main_web_entrypoint": "packages/flutter_ui_bundle/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/flutter_ui_bundle/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:flutter_ui_bundle/main_web_entrypoint.dart") {
          // Clear static caches.
